...
public final class BaseRequest extends
  ...
  public static final Creator<BaseRequest> CREATOR =
  ...
  public BaseRequest clear() {
    ...
    languageVersion = LanguageVersion.CN;
    terminalExt = "";
    registrationId = "";
    iMEI = "";
    opEmployeeID = 0;
    token = "";
    dataCommission = DataCommission.DataCommissionNoSetting;
    deptID = 0;
    sourceCompanyID = 0;
    actID = "";
    jSJID = "";
  ...
  public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
    ...
    if (this.languageVersion != LanguageVersion.CN) {
    ...
    if (this.dataCommission != DataCommission.DataCommissionNoSetting) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        case 72: {
          int value = input.readInt32();
          switch (value) {
            case DataCommission.DataCommissionNoSetting:
            case DataCommission.Personal:
            case DataCommission.Department:
            case DataCommission.DepartmentAndSub:
            case DataCommission.All:
