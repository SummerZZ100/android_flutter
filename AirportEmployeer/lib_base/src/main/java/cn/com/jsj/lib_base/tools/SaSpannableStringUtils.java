...
/**
 * Created by jsj_android on 2017/8/7.
 */
 ...
 * </pre>
 */
public class SaSpannableStringUtils {
    private SaSpannableStringUtils() {
    ...
    public static class Builder {
        ...
        private void setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(new ImageSpan(BaseKTApplication.Companion.getInstance(), bitmap), start, end, flag);
                    bitmap = null;
                    imageIsBitmap = false;
                    ...
                    mBuilder.setSpan(new ImageSpan(BaseKTApplication.Companion.getInstance(), uri), start, end, flag);
                    uri = null;
                    imageIsUri = false;
                } else {
                    mBuilder.setSpan(new ImageSpan(BaseKTApplication.Companion.getInstance(), resourceId), start, end, flag);
                    resourceId = 0;
