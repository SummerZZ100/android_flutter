...
import cn.com.jsj.lib_base.widget.picker.lib_picker.NumberPicker;
 ...
 */
public class SaNumberPicker extends NumberPicker {
    //取消按钮
     ...
     */
    public SaNumberPicker(Activity activity) {
        super(activity);
    }
