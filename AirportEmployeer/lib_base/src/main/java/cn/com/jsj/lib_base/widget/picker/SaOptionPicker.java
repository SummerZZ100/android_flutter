...
import cn.com.jsj.lib_base.widget.picker.lib_picker.OptionPicker;

/**
 * 单项选择picker
 * Created by donghongyu on 16/3/19.
 */
public class SaOptionPicker extends OptionPicker {
     ...
     */
    public SaOptionPicker(Activity activity, String[] options) {
