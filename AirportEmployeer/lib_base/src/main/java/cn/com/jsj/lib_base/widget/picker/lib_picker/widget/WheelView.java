package cn.com.jsj.lib_base.widget.picker.lib_picker.widget;
...
import cn.com.jsj.lib_base.widget.picker.lib_picker.util.LogUtils;
...
public class WheelView extends ScrollView {
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                int startX = viewWidth / 6;
                int stopX = viewWidth * 5 / 6;
                if (mIsSetWidth) {
                    startX = 0;
                    stopX = viewWidth;
                }
                canvas.drawLine(startX, areaBorder[0], stopX, areaBorder[0], paint);
                canvas.drawLine(startX, areaBorder[1], stopX, areaBorder[1], paint);
     ...
     * 设置线条的长度
     *
     * @param isSetWidth 为true设置线条最大长度
     */
    public void setLineFullView(boolean isSetWidth) {
        mIsSetWidth = isSetWidth;
    }
