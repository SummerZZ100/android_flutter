...
public class NetClient {
    ...
    public NetClient(String baseurl, String url, String tag, HttpMethod httpmethod,
                     Map<String, String> headers, Map<String, Object> params, RequestBody reqBody,
                     ZRequest zrequest, IListener listener, ISuccess success, IFailure failure,
                     IError error, File file, String download_dir, String extension, String filename,
                     IProgress progress) {
        BASEURL = baseurl;
        URL = url;
        TAG = tag;
